...
namespace HRMS_Backend.Controllers
{
    ...
    public class AttendanceController : ControllerBase
    {
        ...
        public AttendanceController(IBreakPolicyService breakPolicyService, IAttendanceService attendanceService,IEarlyLogoutService earlyLogoutService,ICompanyPolicyService companyPolicyService,IShiftAllocationService shiftAllocationService, IClockInOutService clockInOutService, ITimesheetService timesheetService, IMissedPunchService service,IWorkFromHomeRequestService workfromhomeservice, ICompanyNewsService companyNewsService)
        {
    ...
    [FromQuery] DateOnly toDate)
     ...
     [FromBody] ClockInOutCreateDto dto)
        ...
        #endregion
        #region breakpolicy
        [HttpPost("GetBreakPolicyAll")]
        public async Task<IActionResult> GetBreakPolicyAll([FromBody] int userId)
        {
            return Ok(await _breakPolicyService.GetAll(userId));
        }

        [HttpPost("GetBreakPolicyById")]
        public async Task<IActionResult> GetBreakPolicyById([FromBody] int id)
        {
            return Ok(await _breakPolicyService.GetById(id));
        }

        [HttpPost("CreateBreakPolicy")]
        public async Task<IActionResult> CreateBreakPolicy([FromBody] BreakPolicyDto dto)
        {
            return Ok(await _breakPolicyService.CreateAsync(dto));
        }

        [HttpPost("UpdateBreakPolicy")]
        public async Task<IActionResult> UpdateBreakPolicy([FromBody] BreakPolicyDto dto)
        {
            return Ok(await _breakPolicyService.UpdateAsync(dto));
        }

        [HttpPost("DeleteBreakPolicy")]
        public async Task<IActionResult> DeleteBreakPolicy([FromBody] int id)
        {
            return Ok(await _breakPolicyService.DeleteAsync(id));
        }
        #endregion
    }
}
